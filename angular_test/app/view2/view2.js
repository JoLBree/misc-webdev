...
.controller('View2Ctrl', ['$scope', '$routeParams', '$filter', function($scope, $routeParams, $filter) {
	...
	var coffees =
       ...
       $scope.reviews = $filter('filter')(coffees, function (d) {return d.id == coffeeId;})[0].reviews;
}]);