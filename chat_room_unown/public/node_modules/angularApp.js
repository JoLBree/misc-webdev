...
app.factory('convos', ['$http', 'auth',function($http, auth){
 var c = {
  ...
  {'author':'Person2', 'content':'Hiyo!', 'format':'text', 'time':new Date()}
  ]},
  {'users':['Gumpkin1', 'Gumpkin2', 'Gumpkin3'],
  'messages':[
  {'author':'Gumpkin1', 'content':'Hi gumps!', 'format':'unown', 'time':new Date()},
  {'author':'Gumpkin2', 'content':'Higo!', 'format':'text', 'time':new Date()}
  ]}
  ]};
  c.getAll = function() {
    ...
    // return $http.get('/convos').success(function(data){
    //   angular.copy(data, c.convos);
    //   console.log(c.convos);
    // });
  };
  c.create = function(convo) {
    ...
    // return $http.post('/convos', convo).success(function(data){
    //   c.convos.push(data);
    // });
  };
  c.get = function(id) {
...
app.controller('HomeCrtl', ['$scope', 'convos', 'auth', function($scope, convos, auth) {
  ...
  $scope.getRows = function() {
    ...
    console.log($scope.actions.length);
